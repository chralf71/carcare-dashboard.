...
function unavailableReport(reason = 'Required technician data could not be validated. No partial totals are shown.') {
  return { status: 'unavailable', directoryStatus: 'unavailable', selectionMode: 'all', rows: [], totals: { hours: unavailableMetric(), jobCount: unavailableMetric() }, reconciliation: { hours: 'unavailable', jobCount: 'unavailable' }, reason };
}
